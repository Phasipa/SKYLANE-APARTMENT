...
<head>
   ...
   <title>SKYLANE APARTEMENT ADMIN | catalog Entry</title>
</head>
<body>
   <div class="sidebar">
	...
	<ul class="nav-links">
	   ...
	   <li>
		<a href="../catalog/catalog.php" class="active">
		   <i class="bx bx-box"></i>
	   ...
	   <div class="form-login">
		<form
            ...
            >
               ...
               <img src="../img_catalog/<?= $data['photo'] ?>" alt="" width="200px">
               <input
                 type="file"
                 name="photo"
                 id="photo"
