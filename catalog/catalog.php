	...
	<section class="home-section">
		...
		<div class="home-content">
			...
			<button type="button" class="btn btn-tambah">
				<a href="catalog-entry.php">Tambah Data</a>
			</button>
			<table class="table-data">
			   ...
			   <tr>
				...
				";
                    ...
                    <tr>
                      <td>
                        <img src='../img_catalog/$data[photo]' width='200px'>
                      </td>
                      <td>$data[catalog]</td>	
					  <td>$data[description]</td>
                      <td>$data[price]</td>
                      <td >
                        <a class='btn-edit' href=catalog-edit.php?id=$data[id]>
                               Edit
                        </a> | 
                        <a class='btn-delete' href=catalog-hapus.php?id=$data[id]>
                            Hapus
                        </a>
                      </td>
                    </tr>
